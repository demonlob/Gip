...
It took lots of work for [my creator](t.me/std_deepanshu) to get me to where I am now, and every donation helps \
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/Teamstdbots"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/deepanshuxd")],
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5642402307 and DONATION_LINK:
